        ...
        <div className="flex items-center space-x-6">
          {name ? (
            ...
            >
              ...
              {showDropdown && (
                <div 
                  className="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg z-10 transition-all duration-200 ease-in-out"
                  style={{ padding: '10px' }} // Aumenta o padding para expandir a área clicável
                >
                  <Link
                    to="/orders"
