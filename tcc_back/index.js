...
var produtoRecomendadosRouter = require('./router/produtoRecomendadorRouter'); // Nova rota para produtos
...
produtoRecomendadosRouter
// Usando as rotas de usuário e produto
app.use("/user", userRouter);
app.use("/produto", produtoRouter);
app.use("/produtoRecomendador", produtoRecomendadosRouter); 
